...
<head>
    ...
    <title>{{ config('app.name', 'VerdeLib') }}</title>
...
<body class="font-sans antialiased text-gray-900 bg-white selection:bg-brand-500 selection:text-white">
    <div class="flex min-h-screen">
        ...
        <div class="hidden lg:flex lg:w-5/12 relative overflow-hidden bg-brand-900">
            ...
            <div class="absolute inset-0 bg-gradient-to-t from-brand-900 via-brand-900/40 to-transparent opacity-90"></div>
            ...
            <div class="relative z-10 w-full h-full flex flex-col justify-between p-12 text-white">
                    ...
                    <div class="p-2 bg-white/10 backdrop-blur-md rounded-lg border border-white/20">
                        <svg class="w-6 h-6 text-brand-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                  d="M12 6.292a8.96 8.96 0 00-6-2.292c-1.052 0-2.062.18-3 .512v14.25c.938-.332 1.948-.512 3-.512 2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25c-.938-.332-1.948-.512-3-.512-2.305 0-4.408.867-6 2.292m0-14.25v14.25"></path>
                        </svg>
                    </div>
                ...
                <div class="mb-12">
                    <h1 class="text-5xl font-extrabold mb-6 leading-tight tracking-tight">
                        Cultivating <br>
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-brand-300 to-emerald-100">Wisdom</span>
                    </h1>
                    <div class="w-20 h-1 bg-brand-500 rounded-full mb-6"></div>
                    <p class="text-lg text-brand-100 font-light leading-relaxed max-w-sm">
                        "The library is the temple of learning, and learning has liberated more people than all other wars in history."
                    </p>
                </div>

                <!-- Bottom Footer -->
                <div class="flex justify-between items-end text-xs text-brand-300/60 font-medium uppercase tracking-widest">
                    <span>Est. 2025</span>
        ...
        <div class="w-full lg:w-7/12 flex flex-col min-h-screen bg-[#FCFCFD] relative">
            ...
            <div class="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-brand-50/40 via-transparent to-transparent pointer-events-none"></div>
            ...
            <div class="w-full flex justify-between items-center p-6 md:p-8 relative z-20">
                ...
                <a href="/" class="lg:hidden flex items-center gap-2 group">
                    ...
                    <span class="text-xl font-bold tracking-tight text-gray-900 group-hover:text-brand-700 transition">VerdeLib.</span>
                </a>
                ...
                <!-- Back to Home Link -->
                <a href="/" class="flex items-center gap-2 text-sm font-medium text-gray-500 hover:text-brand-600 transition px-4 py-2 rounded-full hover:bg-white hover:shadow-sm">
